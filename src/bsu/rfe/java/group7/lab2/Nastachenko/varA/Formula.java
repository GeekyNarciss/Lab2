package bsu.rfe.java.group7.lab2.Nastachenko.varA;
...
public class Formula extends JFrame {
    ...
    public Double calculate1(Double x, Double y, Double z) {
        ...
        return Math.pow(Math.cos(Math.exp(x))+ Math.log(Math.pow(1 + y, 2)) + Math.sqrt(Math.exp(Math.cos(x))+ Math.pow(Math.sin(Math.PI * z),2)) +
